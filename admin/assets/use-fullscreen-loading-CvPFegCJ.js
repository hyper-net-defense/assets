import"./index-Dy79iS0B.js";/* empty css                *//* empty css                  *//* empty css                 *//* empty css                   */import{a4 as _,$ as f,z as g,N as y,E as l}from"./element-B-FiLDCl.js";import{v as E,x as w,y as h,O as n,F as c,K as u}from"./vue-Cwi6Gi-M.js";import{_ as x}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./vxe-5K_zVHhu.js";const A={lock:!0,text:"Loading..."},p=(t,e={})=>{let r;return async(...a)=>{try{return r=_.service({...A,...e}),await t(...a)}finally{r.close()}}},S={code:0,data:{list:[]},message:"Request successful"};function C(t){return new Promise(e=>{setTimeout(()=>{e({...S,data:{list:t}})},1e3)})}function v(){return new Promise((t,e)=>{setTimeout(()=>{e(new Error("An error occurred"))},1e3)})}const k={class:"app-container"},L=`
  <path class="path" d="
    M 30 15
    L 28 17
    M 25.61 25.61
